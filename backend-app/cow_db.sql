CREATE DATABASE  IF NOT EXISTS `cow_db` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */;
USE `cow_db`;
-- MySQL dump 10.13  Distrib 8.0.19, for Win64 (x86_64)
--
-- Host: localhost    Database: cow_db
-- ------------------------------------------------------
...
CREATE TABLE `cows` (
  ...
  `kaki` varchar(20) NOT NULL,
  `mulut` varchar(20) NOT NULL,
...
CREATE TABLE `users` (
  ...
  `role` ENUM('admin', 'user', 'puskesmas', 'guest'),
  `createdAt` datetime NOT NULL,
  `updatedAt` datetime NOT NULL,
  PRIMARY KEY (`id`)
